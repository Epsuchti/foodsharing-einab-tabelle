...
public interface FoodsharingOpenSlotAdvertisementAuditRepository extends JpaRepository<FoodsharingOpenSlotAdvertisementAudit, UUID> {
    ...
    java.util.List<FoodsharingOpenSlotAdvertisementAudit> findAllByAutomationAdminConnectionAndPickupDateAndTelegramMessageIdIsNotNullAndTelegramDeletedAtIsNull(FoodsharingAdminConnection adminConnection, Instant pickupDate);
